...
class BooksChat extends StatefulWidget {
  const BooksChat({Key? key}) : super(key: key);
  static const String screenRoute='books_chat';

  @override
  _BooksChatState createState() => _BooksChatState();
}

class _BooksChatState extends State<BooksChat> {
...
class MessageStreamBuilder extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        stream: _fireStore.collection('books').orderBy('time').snapshots(),
